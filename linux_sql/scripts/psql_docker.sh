...
case $cmd in 
  ...
  # Start the container
	docker run --name jrvs-psql -e POSTGRES_PASSWORD=$db_username -e POSTGRES_PASSWORD=$db_password -d -v pgdata:/var/lib/postgresql/data -p 5432:5432 postgres:9.6-alpine
